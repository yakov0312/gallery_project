...
public:
	...
	virtual bool doesAlbumExists(const std::string& albumName, int userId) const = 0;
	virtual Album openAlbum(const std::string& albumName, const int userId) = 0;
	virtual void closeAlbum(Album& pAlbum) = 0;
	virtual void printAlbums() = 0;

    // picture related
	virtual void addPictureToAlbumByName(const std::string& albumName, const Picture& picture, const int ownerId) = 0;
	virtual void removePictureFromAlbumByName(const std::string& albumName, const std::string& pictureName, const int ownerId) = 0;
	...
	virtual int createUser(User& user ) = 0;
	virtual void deleteUser(const User& user) = 0;
	virtual bool doesUserExists(int userId) const = 0 ;
